...
public class ConfessionTest extends JComponent{
    /**
	 * 
	 */
    ...
    protected void paintComponent(Graphics g) {
     ...
     //   GradientPaint background = new GradientPaint(0f, 0f, Color.GRAY.darker(),
        ...
        GradientPaint background = new GradientPaint(0f, 0f, Color.MAGENTA.darker(),
                0f, (float)getHeight(), Color.MAGENTA.brighter());
        ...
        //导入图片
        Image img = Toolkit.getDefaultToolkit().getImage("D:\\file\\confession.jpg");
		//g2d.drawImage(img, 0, 230, 500, 600, Color.LIGHT_GRAY, this);
		g2d.drawImage(img, 0, 230, 567, 378, Color.LIGHT_GRAY, this);
