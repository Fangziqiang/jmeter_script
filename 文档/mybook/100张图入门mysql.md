...
![img](https://mmbiz.qpic.cn/mmbiz_png/libYRuvULTdUqmGNFicK1sjvE6sqzQdibohMTUic4Zz92HIC6XJia3jSXJLFjwGrshpvAcqicKLErVscASgmQWp0VGcQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

- WEEK(DATE) 和 YEAR(DATE) ：前者返回的是一年中的第几周，后者返回的是给定日期的哪一年

![img](https://mmbiz.qpic.cn/mmbiz_png/libYRuvULTdUqmGNFicK1sjvE6sqzQdibohzPAD4hT0ljric5EgPFCcDfcMZXhdFd0td8icNnyPck7Xz1Zic6ObUWnlQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](https://mmbiz.qpic.cn/mmbiz_png/libYRuvULTdUqmGNFicK1sjvE6sqzQdibohWCZm9425MDBGZUIrwMEgztQB74VxccaLHGOHLhjj3VApb4B9LcICLw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

- CURDATE() 函数：返回当前日期，只包含年月日

![img](https://mmbiz.qpic.cn/mmbiz_png/libYRuvULTdUqmGNFicK1sjvE6sqzQdibohOO1nfzKtyXaBRFuME1oh66ZSYuz0BkicatRC9HEm1y9Il8kLE9UTZCA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

- CURTIME() 函数：返回当前时间，只包含时分秒

![img](https://mmbiz.qpic.cn/mmbiz_png/libYRuvULTdUqmGNFicK1sjvE6sqzQdibohFckOBxZerJCe8912pf3dcvtZkjUqDibPtEYGSESAaA2cp3ic9gzbEjXQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

- UNIX_TIMESTAMP(date) : 返回 UNIX 的时间戳

![img](https://mmbiz.qpic.cn/mmbiz_png/libYRuvULTdUqmGNFicK1sjvE6sqzQdibohB8I81Y0mGrEwShicb5UCchZrwee0f4EUWmKs9mskGadtB9icxLB8HL8w/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

- FROM_UNIXTIME(date) : 返回 UNIXTIME 时间戳的日期值，和 UNIX_TIMESTAMP 相反

![img](https://mmbiz.qpic.cn/mmbiz_png/libYRuvULTdUqmGNFicK1sjvE6sqzQdiboh8VcQwvFPsaWBm20iaCfKj4gnSDdahpIOWiaCDeFWmHrqIMfEYdWZ5TLQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](https://mmbiz.qpic.cn/mmbiz_png/libYRuvULTdUqmGNFicK1sjvE6sqzQdibohB7JTNiakmJejZlJofRLfEW9bq5tUPSXk1h3ibia4SW0rNib1ibwDj6xXliaw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](https://mmbiz.qpic.cn/mmbiz_png/libYRuvULTdUqmGNFicK1sjvE6sqzQdibohI1wH0K9bMIhN1jHC9WRAjDNSUQgCjZ99oAa2d77uzUAx2MherQpIBQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](https://mmbiz.qpic.cn/mmbiz_png/libYRuvULTdUqmGNFicK1sjvE6sqzQdibohl5J3Rz2nQX8Qz63ZYdTIx8TEPRXD8T2fep6qxWgrZIyGlR8Jf7cZYw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

- DATABASE: 返回当前的数据库名

![img](https://mmbiz.qpic.cn/mmbiz_png/libYRuvULTdUqmGNFicK1sjvE6sqzQdibohQ4AUiaQ4DiafUPLmdqRHEiboID5D1KFXaETE7yseamBGF2ibx0SWFn7icicw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

- USER : 返回当前登录用户名

![img](https://mmbiz.qpic.cn/mmbiz_png/libYRuvULTdUqmGNFicK1sjvE6sqzQdiboh3TLSDrEjgU3UYDibskNyJyds3fhwhcq1Nhy0ib5PqoWeGnngZc7axaEA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

- PASSWORD(str) : 返回字符串的加密版本，例如

![img](https://mmbiz.qpic.cn/mmbiz_png/libYRuvULTdUqmGNFicK1sjvE6sqzQdibohoSIywYibzIDsWjLgLYAbyWPqIdb9ttyUHtYORWa2ej6nE4iaGrWPhePA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

- MD5(str) 函数：返回字符串 str 的 MD5 值

![img](https://mmbiz.qpic.cn/mmbiz_png/libYRuvULTdUqmGNFicK1sjvE6sqzQdiboh6nkibFLop7QtvMG3S4SicGGLEfGzfNghibqlQjHcCKrPlW8aFeV7u0e3A/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

- INET_ATON(IP): 返回 IP 的网络字节序列

![img](https://mmbiz.qpic.cn/mmbiz_png/libYRuvULTdUqmGNFicK1sjvE6sqzQdibohQe2Rt6ZMQk57C5AM2ZVAWWQAAk3bbwic0ps1IPXsW3CsGFqPh1hAZJA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

- INET_NTOA(num)函数：返回网络字节序列代表的 IP 地址，与 INET_ATON 相对

![img](https://mmbiz.qpic.cn/mmbiz_png/libYRuvULTdUqmGNFicK1sjvE6sqzQdibohNNGor187yGibj3CaK5A69kONg9sTYFH9U3CwvwXUlvAOqHs0bmlWNPQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
